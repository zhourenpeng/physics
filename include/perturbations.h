...
struct perturbations
{
  ...
  short has_source_delta_nudm; /**< do we need source for delta of CDM with nu interactions? */
  ...
  short has_source_theta_nudm; /**< do we need source for theta of CDM interacting with baryons? */
  ...
  int index_tp_delta_nudm; /**< index value for delta of CDM with nu interactions */
  ...
  int index_tp_delta_cdm2; /**< index value for delta of cdm2 */
  ...
  int index_tp_theta_nudm; /**< index value for theta of CDM interacting with nu */
  ...
  int index_tp_theta_cdm2;  /**< index value for theta of cdm2 */
...
struct perturbations_vector
{
  ...
  int index_pt_delta_nudm;/**< nudm density */
  int index_pt_theta_nudm; /**< nudm velocity */
  ...
  int index_pt_delta_cdm2; /**< cdm2 density */
  int index_pt_theta_cdm2; /**< cdm2 velocity */
...
struct perturbations_workspace
{
  ...
  */
  ...
  double * nudm_interaction_term; /**< Integrated interaction term between each ncdm species and nudm */
